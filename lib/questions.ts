...
export const QUESTIONS: Question[] = [
  {
    ...
    opts: [
      { t: "LLM, Memoria y Schemas", ok: false },
      { t: "Cerebro (LLM), Prompt y Herramientas (Tools)", ok: false },
      { t: "Knowledge, Prompting y Tools", ok: true },
  ...
  },
  {
    ...
    opts: [
      ...
      {
        t: "Porque el Chatbot solo responde preguntas predefinidas sin ejecutar acciones en sistemas externos.",
        ok: true,
      },
  ...
  },
  {
    ...
    opts: [
      {
        t: "El paso donde el modelo 'presta atención' a las partes más relevantes.",
        ok: false,
      },
      { t: "La generación de una respuesta coherente.", ok: false },
      {
        t: "La división del texto fuente en unidades procesables (tokens).",
        ok: true,
      },
  ...
  },
  {
    ...
    opts: [
      ...
      {
        t: "Requiere intervención humana constante para cada tarea.",
        ok: false,
      },
      {
        t: "Interactúa directamente con humanos por WhatsApp o Instagram.",
        ok: false,
      },
      {
        t: "No requiere interacción directa y se activa por eventos (nuevo correo, horario) funcionando en segundo plano.",
        ok: true,
      },
    ],
  },
  {
    ...
    opts: [
      {
        t: "Limitar el contexto al mínimo para que la IA sea creativa.",
        ok: false,
      },
      {
        t: "Ser Específico, detallando la asignatura, el nivel o el formato esperado.",
        ok: true,
      },
  ...
  },
  {
    ...
    opts: [
      {
        t: "Obtiene información del servidor (datos, documentos, consultas).",
        ok: false,
      },
      {
        t: "Envía información al servidor para crear registros, actualizar datos o ejecutar acciones.",
        ok: true,
      },
  ...
  },
  {
    ...
    opts: [
      {
        t: "Evitar decisiones injustas o discriminatorias en los modelos.",
        ok: false,
      },
      { t: "Asegurar que se pueda entender cómo decide un modelo.", ok: true },
      {
        t: "Manejar responsablemente los datos personales según la ley.",
        ok: false,
      },
      {
        t: "Considerar el alto uso energético de los grandes modelos.",
        ok: false,
      },
    ],
  },
